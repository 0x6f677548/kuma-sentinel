...
class TestGetPoolStatus:
    ...
    def test_get_pool_status_success_online(self):
        """Test successful pool status retrieval with ONLINE status."""
        MagicMock()
        checker_instance = MagicMock()
        checker_instance.run_command.return_value = (
            True,
            "tank\t1.81T\t1.00T\t828G\t55%\tONLINE\n",
            "",
            0,
        )

        health, free_percent = _get_pool_status(checker_instance, "tank")

        assert health == "ONLINE"
        assert free_percent == 45.0  # 100 - 55

    def test_get_pool_status_success_degraded(self):
        """Test successful pool status retrieval with DEGRADED status."""
        MagicMock()
        checker_instance = MagicMock()
        checker_instance.run_command.return_value = (
            True,
            "tank\t1.81T\t1.00T\t828G\t75%\tDEGRADED\n",
            "",
            0,
        )
    ...
    def test_get_pool_status_success_faulted(self):
        """Test successful pool status retrieval with FAULTED status."""
        MagicMock()
        checker_instance = MagicMock()
        checker_instance.run_command.return_value = (
            True,
            "tank\t1.81T\t1.00T\t828G\t90%\tFAULTED\n",
            "",
            0,
        )
    ...
    def test_get_pool_status_empty_output(self):
    ...
    def test_get_pool_status_insufficient_fields(self):
    ...
    def test_get_pool_status_invalid_capacity_format(self):
        """Test when capacity field cannot be parsed."""
        MagicMock()
        checker_instance = MagicMock()
        checker_instance.run_command.return_value = (
            True,
            "tank\t1.81T\t1.00T\t828G\tINVALID\tONLINE\n",
            "",
            0,
        )
    ...
    def test_get_pool_status_decimal_capacity(self):
        """Test capacity parsing with decimal percentage."""
        MagicMock()
        checker_instance = MagicMock()
        checker_instance.run_command.return_value = (
            True,
            "tank\t1.81T\t1.00T\t828G\t55.5%\tONLINE\n",
            "",
            0,
        )
    ...
    def test_get_pool_status_timeout(self):
        """Test timeout during zpool command execution."""
        MagicMock()
        checker_instance = MagicMock()
        checker_instance.run_command.side_effect = subprocess.TimeoutExpired(
            "zpool", 30
        )
    ...
    def test_get_pool_status_called_process_error(self):
        """Test CalledProcessError from zpool command."""
        MagicMock()
        checker_instance = MagicMock()
        checker_instance.run_command.return_value = (False, "", "no such pool", 1)
    ...
    def test_get_pool_status_file_not_found(self):
    ...
    def test_get_pool_status_subprocess_call(self):
        ...
        _get_pool_status(checker_instance, "tank")

        # Verify run_command was called with correct args
        call_args = checker_instance.run_command.call_args
    ...
    def test_get_pool_status_multiple_pools_different_values(self):
        ...
        health1, free1 = _get_pool_status(checker_instance, "tank")

        # Second call
        checker_instance.run_command.return_value = (
            True,
            "backup\t2.0T\t1.5T\t500G\t75%\tONLINE\n",
            "",
            0,
        )
        health2, free2 = _get_pool_status(checker_instance, "backup")
    ...
    def test_get_pool_status_edge_case_0_percent_capacity(self):
        """Test pool with 0% capacity (100% free)."""
        MagicMock()
        checker_instance = MagicMock()
        checker_instance.run_command.return_value = (
            True,
            "tank\t1.81T\t0\t1.81T\t0%\tONLINE\n",
            "",
            0,
        )
    ...
    def test_get_pool_status_edge_case_100_percent_capacity(self):
        """Test pool with 100% capacity (0% free)."""
        MagicMock()
        checker_instance = MagicMock()
        checker_instance.run_command.return_value = (
            True,
            "tank\t1.81T\t1.81T\t0\t100%\tONLINE\n",
            "",
            0,
        )
    ...
    def test_get_pool_status_whitespace_handling(self):
    ...
    def test_get_pool_status_offline_status(self):
        """Test pool with OFFLINE status."""
        MagicMock()
        checker_instance = MagicMock()
        checker_instance.run_command.return_value = (
            True,
            "tank\t1.81T\t1.00T\t828G\t55%\tOFFLINE\n",
            "",
            0,
        )
    ...
    def test_get_pool_status_unavail_status(self):
        """Test pool with UNAVAIL status."""
        MagicMock()
        checker_instance = MagicMock()
        checker_instance.run_command.return_value = (
            True,
            "tank\t1.81T\t1.00T\t828G\t55%\tUNAVAIL\n",
            "",
            0,
        )
